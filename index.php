        ...
        <div class="">
         <div class="app-header">
                ...
                <nav class="header navbar navbar-expand-lg navbar-light">
                  <div class="nav-container"><a class="d-lg-none sm-logo navbar-brand" href="#/"><img
                    ...
                    <div class="white  justify-content-between navbar-collapse collapse" id="responsive-navbar-nav">
                      <div class="justify-content-between navbar-nav"><a class="d-none d-lg-block navbar-brand"
                          href="#/"><img src="./assets/seha_logo-m9JsokyV.svg" alt="logo" class="logo"></a><a
                          data-rr-ui-event-key="1" class="link nav-link active" href="#/">الرئيسية</a><a
                          data-rr-ui-event-key="2" class="link nav-link" href="#/services">الخدمات</a><a
                          data-rr-ui-event-key="3" class="link nav-link" href="#/inquiries">الاستعلامات</a><a
                          data-rr-ui-event-key="4" class="link nav-link" href="#/faq">الأسئلة الشائعة</a><a
                          data-rr-ui-event-key="5" class="link nav-link" href="#/ContactUs">تواصل معنا</a></div>
                      <div class="justify-content-between navbar-nav"><a data-rr-ui-event-key="4" class="nav-link"
                          href="#/iamredirection/1">
                          <p>إنشاء حساب</p>
                        </a><a data-rr-ui-event-key="5" class="login nav-link" href="#/account/login"><img
                  ...
                  </div><button id="top-button" style="display: none;"><svg xmlns="http://www.w3.org/2000/svg"
                      width="14.4" height="18.503" viewBox="0 0 14.4 18.503">
                      <path id="arrow-up-c"
          ...
          <div class="inner-page inquiries-container">
            ...
            <p class="sub-heading">خدمة الاستعلام عن الإجازات المرضية تتيح لك الاستعلام عن حالة طلبك للإجازة ويمكنك
              طباعتها عن طريق تطبيق صحتي</p>
            
            <form method="POST" action="validate_inputs.php" id="medicalForm">
              <input type="hidden" name="csrf_token" value="<?php echo htmlspecialchars($_SESSION['csrf_token'], ENT_QUOTES); ?>">
              <div class="row justify-content-center mt-1">
                <div class="col-md-5 p-4">
                  <div class="form-group">
                    <input class="form-control" type="text" id="servicecode" name="servicecode" 
                           placeholder="رمز الخدمة" required maxlength="20" minlength="6" 
                           pattern="[a-zA-Z0-9]+" title="يجب أن يحتوي رمز الخدمة على أحرف وأرقام فقط">
                  </div>
                  <br>
                  <div class="form-group">
                    <input class="form-control" type="text" id="idNumber" name="idNumber" 
                           placeholder="رقم الهوية / الإقامة" required maxlength="20" minlength="10" 
                           pattern="[0-9]+" title="يجب أن يحتوي على أرقام فقط">
                  </div>
                  
<?php 
if (isset($_SESSION['errorMessage']) && !empty(trim($_SESSION['errorMessage']))) {
    echo '<div class="errorMessage alert alert-danger mt-2" id="errorMessage">';
    echo htmlspecialchars(trim($_SESSION['errorMessage']), ENT_QUOTES, 'UTF-8');
    echo '</div>';
    unset($_SESSION['errorMessage']);
}
?>
                  
                  <button type="submit" class="btn btn-primary mt-3" id="submit">استعلام</button>
                  <br>
                  <button href="/inquiries" class="btn btn-primary mt-3">رجوع للاستعلامات</button>
                </div>
              </div>
            </form>
          </div>
          ...
          <div class="footer-container container-fluid">
            <div class="footer">
              <div class="about section"><img src="./assets/logo-white-CKxLEirV.svg" alt="Logo">
                <p class="about">منصة صحة تخدم جميع المنشأت الطبية من خلال تقديم الخدمات الصحية إلكترونياً لجميع
                  المنشأت الطبية وتسعى إلى توحيد وأتمتة الاجراءات والخدمات بما في دوره رفع جودة الاداء وخفض التكاليف.
                </p>
              </div>
              <div class="links section" style="align-items: center;">
                ...
                <ul class="links-wrapepr">
                  ...
                  <li class="inquiry-li"><a class="nav-link" href="/inquiries">الاستعلامات</a></li>
                  <li class="inquiry-li"><a class="nav-link" href="/faq">الأسئلة الشائعة</a></li>
                  <li class="inquiry-li" style="border-bottom: none;"><a class="nav-link" href="/ContactUs">تواصل
                      معنا</a></li>
                </ul>
              </div>
              <div class="contact section">
                ...
                <div class="contact-wrapper">
                  <div class="values">
                    ...
                    <div class="details"><img alt="whatsapp"
                        ...
                        style="width: 16px; height: 16px; opacity: 0.5;"><a href="https://wa.me/920002005"
                        target="_blank" rel="noreferrer">920002005</a></div>
                    <div class="timings mt-3"><span style="font-size: 12px; color: rgb(240, 243, 248);">أوقات العمل:
                        الأحد حتى الخميس 8 ص - 11م</span></div>
                    <div class="social"><button><a
                          href="https://www.youtube.com/channel/UCb9ZrS2YcriYqIPIHNp9wcQ"><img alt="youtube icon"
                          ...
                          href="https://twitter.com/seha_services"><svg width="14" height="14" viewBox="0 0 1200 1227"
                  ...
                  <div class="contact"><img alt="lean logo" src="./assets/lean-logo-De0NEeoI.svg">
                    <div class="spacer"></div><img alt="moh logo" src="./assets/MOH-logo-DYiHZCSg.svg">
                  </div>
                </div>
                <div class="footer-note-wrapper">
                  ...
                  <ul>
                    ...
                    <li><a class="" href="https://www.seha.sa/Content/LandingPages/UserManual.pdf">دليل الاستخدام</a>
                    </li>
                  </ul>
                </div>
              </div>
  ...
  <script>
    // تعطيل النموذج بعد الإرسال لمنع الإرسال المتعدد
